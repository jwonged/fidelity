...
class VanillaLSTMModel(BaseModel):
    '''
    Regular single generative lstm
    '''

    def __init__(self, config):
        super(VanillaLSTMModel, self).__init__(config)
    ...
    def loadTrainedModel(self, restoreModel, restoreModelPath):
        graph = super(VanillaLSTMModel, self).loadTrainedModel(restoreModel, restoreModelPath)
        if self.config.stackAtt:
